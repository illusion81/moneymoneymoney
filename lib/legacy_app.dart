...
import 'screens/legacy_report_screen.dart';
...
/// Entrypoint for the legacy Forest app, kept for reference and tests.
/// The shipping entrypoint is `main.dart` (Hivewise UI).
void runLegacyApp() {
  runApp(const MyApp());
}
