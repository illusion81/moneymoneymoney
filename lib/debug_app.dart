...
class _HomeState extends State<_Home> {
  ...
  Future<void> _survey() => c.submitSurvey(const SurveyAnswers(
        monthlyIncome: 2700,
        fixedCosts: 1500,
        riskAppetite: 4,
        horizonMonths: 24,
          ...
          body: RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                if (c.tower != null) ...[
                  Text('Tower — stage ${c.tower!.stage}, '
                ...
                if (c.progression != null)
                  Text('Level ${c.progression!.level} · '
